...
Future<void> _openFilterDialog(BuildContext context) async {
  ...
  int? selAgentId   = vm.agentId; // 0 for ALL if needed
                        ...
                        return DropdownButtonFormField<int>(
                          ...
                          items: items
                            ...
                            child: Text(p.productName, overflow: TextOverflow.ellipsis),
                              ...
                              .toList(),
                          onChanged: (v) => setStateDialog(() => selProductId = v),
                        ...
                        return DropdownButtonFormField<int>(
                          ...
                          items: items
                            ...
                            child: Text(a.name, overflow: TextOverflow.ellipsis),
                              ...
                              .toList(),
                          onChanged: (v) => setStateDialog(() => selAgentId = v),
...
class _SalesTableView extends StatefulWidget {
  ...
  @override
  State<_SalesTableView> createState() => _SalesTableViewState();
}

class _SalesTableViewState extends State<_SalesTableView> {
